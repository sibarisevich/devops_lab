...
if reportformat == "txt":
    report.write("Snapshot number; Carrent Time; % CPU load; Memory total; Swap memory; Disk IO; Networks bites send \n")
...
while i <= count:
    ...
    if reportformat == "json":
        temp = json.dumps({
            ...
            "Networks bites send": str(first.network())
            }, indent=4)
        report.write(temp)
        time.sleep(timetosleep*60)
